...
class GetTrainingPreflightRunUseCase:
    def __init__(
        self,
    ...
    def execute(self, preflight_run_id: UUID) -> TrainingPreflightRunDTO:
        ...
        return TrainingPreflightRunDTO.from_entity(preflight_run, issues)
