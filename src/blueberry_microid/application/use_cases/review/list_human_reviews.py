...
class ListHumanReviewsUseCase:
    """List HumanReview history in chronological ascending order."""
    ...
    def execute(self, analysis_run_id: UUID) -> list[HumanReviewDTO]:
        ...
        return [
            HumanReviewDTO.from_entity(review)
            for review in self._human_review_repository.list_by_analysis_run_id(analysis_run_id)
        ]
