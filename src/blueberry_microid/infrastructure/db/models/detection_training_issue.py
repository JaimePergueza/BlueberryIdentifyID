...
class DetectionTrainingIssueModel(Base):
    __tablename__ = "detection_training_issues"
    __table_args__ = (
        CheckConstraint(
            "severity IN ('error', 'warning', 'info')", name="ck_detection_training_issues_severity"
        ),
    )
