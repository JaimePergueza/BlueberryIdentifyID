...
class SqlAlchemyDatasetReleaseRepository(DatasetReleaseRepositoryPort):
    ...
    def add(self, dataset_release: DatasetRelease) -> DatasetRelease:
        model = DatasetReleaseModel(
            ...
            release_kind=dataset_release.release_kind.value,
            status=dataset_release.status,
            description=dataset_release.description,
            ...
            manifest=dataset_release.manifest,
            provenance=dataset_release.provenance,
